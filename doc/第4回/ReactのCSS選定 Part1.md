...
通常のCSSやSCSSなどのCSSメタ言語を利用する方法や、PureCSSと近い感覚で記述できて、スタイルの有効範囲を限定することができるCSS Modules、いっそCSSもJavaScriptで書いてしまおうという思想から誕生したCSS in JSなど、どれを選べばいいかわからないという方が多いのではないでしょうか？   
...
* 【一番重要】それぞれの概要だけザックリ捉えておいて、技術選定する時の基準を作っておくことが重要！
